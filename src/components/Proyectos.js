      ...
      <main>
        ...
        >
          <article className="relative flex flex-col justify-between w-full py-6 px-7">
            <h2 className="text-gray-700 dark:text-gray-200 text-lg font-bold">
              Consultor de criptomonedas
            </h2>
            <p className="text-slate-400 dark:text-slate-200">
              Consulta criptomonedas en tiempo real
            </p>
            <div className="flex gap-1 mt-1.5 items-center">
              ...
              <div className="relative group/tooltip">
                <svg width="20" height="20" viewBox="0 0 52 45" fill="none" xmlns="http://www.w3.org/2000/svg" className="h-4"
                >
                  <path
            ...
            <div className="absolute grid place-items-center right-3 top-3 bg-white dark:bg-gray-800 w-9 h-9 rounded-full scale-0 group-hover:scale-90 transition-transform dark:opacity-80 border-0 border-slate-100 border-indigo-100/50 dark:border-slate-200/20 shadow-sm">
              <div className="i-fa-pro:arrow-up-right text-gray-400 dark:text-gray-50 text-2xl"></div>
            </div>
          </article>
        </a>
        ...
        >
          <article className="relative flex flex-col justify-between w-full py-6 px-7">
            ...
            <p className="text-slate-400 dark:text-slate-200">
              Página para agregar productos y unidades a un carrito y calcular el gasto total
            </p>
            <div className="flex gap-1 mt-1.5 items-center">
              <div className="relative group/tooltip">
                <svg
        ...
        >
          <article className="relative flex flex-col justify-between w-full py-6 px-7">
            <h1 className="text-gray-700 dark:text-gray-200 text-lg font-bold">
            Más proyectos
            </h1>
